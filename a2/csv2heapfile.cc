...
int main(int argc, const char *argv[])
{
    ...
    const char *heap_file_name = argv[2];
    ...
    FILE *heap_file_ptr = fopen(heap_file_name, "w+"); // Open file for read & write, start at beginning.
    ...
    init_heapfile(heapfile, page_size, heap_file_ptr, true);
